...
from llava.constants import DEFAULT_IMAGE_PATCH_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN, HF_CACHE_DIR
...
def load_pretrained_model(model_path, model_base, model_name, load_8bit=False, load_4bit=False, device_map="auto", device="cuda", use_flash_attn=False, **kwargs):
    ...
    if 'llava' in model_name.lower():
        ...
        if 'lora' in model_name.lower() and model_base is not None:
            ...
            model = PeftModel.from_pretrained(model, model_path, **kwargs) # mainly so the correct device is used
    ...
    if 'llava' in model_name.lower():
        ...
        if device_map != 'auto':
            ...
            vision_tower.to(dtype=model.dtype, device=model.device)
...
def load_pretrained_model_t5(model_cls,
                             model_args,
                             model_path=None,
                             tokenizer_path=None,
